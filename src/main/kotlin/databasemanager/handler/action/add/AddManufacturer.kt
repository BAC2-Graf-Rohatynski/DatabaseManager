...
object AddManufacturer: ICommandHandlerAction {
    private val logger: Logger = LoggerFactory.getLogger(AddManufacturer::class.java)
    private lateinit var item: ManufacturerItem

    @Synchronized
    override fun run(): Any {
        logger.info("Command '${DatabaseCommand.AddManufacturer.name}' will be executed ...")
        return ManufacturerDatabaseHandler.addItem(item = item)
    }
